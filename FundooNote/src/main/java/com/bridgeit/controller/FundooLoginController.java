...
public class FundooLoginController {
	...
	public ModelAndView loginuser(@ModelAttribute("loginuser") @PathParam("loginuser") Login loginuser,
		...
		if (reg != null) {
			...
			logger.info(session);
			logger.info(reg.getName() + " " + reg.getPassword() + reg.getUser_id());
